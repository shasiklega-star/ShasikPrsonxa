-- ============================================
-- SHASIK_1488 ULTIMATE EDITION (ШИРОКАЯ ВЕРСИЯ)
-- PRISON RP | ДИЗАЙН | ЗВУК | ТУМБЛЕР
-- ============================================
...
-- ============================================
-- ПРИЯТНЫЙ ЗВУК (ИСПОЛЬЗУЕТСЯ ВО ВСЁМ СКРИПТЕ)
-- ============================================
function playClick()
    pcall(function()
        local sound = Instance.new("Sound", workspace)
        sound.SoundId = "rbxassetid://9120381960"  -- Приятный клик
        sound.Volume = 0.3
