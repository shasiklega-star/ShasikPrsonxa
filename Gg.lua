-- Prison RP Script v23.0 | by shasik_1488 | FINAL WORKING VERSION
...
-- ============================================
-- БЕССМЕРТИЕ (ГАРАНТИРОВАННО РАБОТАЕТ)
-- ============================================
function tGodmode()
...
-- ============================================
-- ПРОСТОЕ И БЫСТРОЕ МЕНЮ
-- ============================================
local gui = Instance.new("ScreenGui", game.CoreGui)
gui.Name = "ShasikCheat"

-- ============================================
-- ИКОНКА (СРЕДНЯЯ, КРАСИВАЯ, С ИМЕНЕМ)
-- ============================================
...
-- ============================================
-- ОТКРЫТИЕ МЕНЮ (РАБОТАЕТ БЕЗ ЗАДЕРЖЕК)
-- ============================================
