-- Prison RP Script v19.0 | by shasik_1488 | SPEED SLIDER
...
-- ============================================
-- МЕНЮ (С ПОЛЗУНКОМ СКОРОСТИ)
-- ============================================
local gui = Instance.new("ScreenGui", game.CoreGui)
gui.Name = "ShasikCheat"

-- Иконка (золотая звезда)
...
-- Ползунок (появляется только когда скорость включена)
