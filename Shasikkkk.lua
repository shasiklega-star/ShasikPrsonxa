-- ============================================
-- ULTRA MEGA CHEAT V20.0 (NEON PANEL)
-- by shasik_1488 | СВЕТЯЩАЯСЯ ПАНЕЛЬ
-- ============================================
...
-- ============================================
-- ГЛАВНОЕ МЕНЮ С НЕОНОВОЙ ПАНЕЛЬЮ
-- ============================================
...
-- ============================================
-- НЕОНОВАЯ ПАНЕЛЬ (СВЕТИТСЯ РАЗНЫМИ ЦВЕТАМИ)
-- ============================================
local panel = Instance.new("ImageButton", gui)
panel.Size = UDim2.new(0.5, 0, 0, 40)
panel.Position = UDim2.new(0.25, 0, 0, -40)
...
strokePanel.Transparency = 0.6

-- Анимация свечения (меняем цвет обводки)
local colors = {
    Color3.fromRGB(0, 200, 255),   -- синий
    Color3.fromRGB(255, 0, 200),   -- розовый
    Color3.fromRGB(200, 0, 255),   -- фиолетовый
    Color3.fromRGB(0, 255, 200),   -- бирюзовый
    Color3.fromRGB(255, 200, 0),   -- золотой
    Color3.fromRGB(255, 0, 100),   -- красный
}
...
spawn(function()
    while true do
        ...
        strokePanel.Transparency = 0.3 + math.sin(tick() * 2) * 0.2
...
panel.MouseButton1Click:Connect(function()
    ...
    if menuCollapsed then
        ...
        panelLabel.Text = "✦ shasik_1488 ✦  [▲]"
        panel.Position = UDim2.new(0.25, 0, 0, 0)
    else
        frame:TweenSize(UDim2.new(0, 360, 0, 550), "Out", "Quad", 0.3)
        panelLabel.Text = "✦ shasik_1488 ✦  [▼]"
        panel.Position = UDim2.new(0.25, 0, 0, -40)
    end
end)
...
print("✅ ULTRA MEGA CHEAT V20.0 by shasik_1488 загружен!")
