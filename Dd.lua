-- ============================================
-- PRISON RP ULTRA V68 (SILENT AIM + FOV)
...
game:GetService("RunService").PreRender:Connect(function()
    ...
    if target then
        fovCircle.Color = Color3.fromRGB(0, 255, 0)
        -- Наводим камеру на цель (опционально)
...
-- ============================================
-- МЕНЮ (КРАТКАЯ ВЕРСИЯ С SILENT AIM)
-- ============================================
...
print("✅ PRISON RP ULTRA V68 by shasik_1488 загружен!")
