...
frame.ClipsDescendants = true  -- ОБРЕЗАЕМ ВСЁ, ЧТО ВЫХОДИТ ЗА РАМКИ
...
-- ============================================
-- СНЕГ (ТОЛЬКО ВНУТРИ МЕНЮШКИ)
-- ============================================
local snowContainer = Instance.new("Frame", frame)  -- ПРИВЯЗЫВАЕМ К FRAME!
