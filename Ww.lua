-- ============================================
-- PRISON RP ULTRA V42 (ФИКС СПИДХАКА)
...
-- ============================================
-- МЕНЮ (С НАСТРОЙКОЙ ЦВЕТА И ЯЗЫКА)
-- ============================================
...
function updateContent()
    ...
    if currentCategory == txt.categories[1] then -- Main / Главная
    ...
    elseif currentCategory == txt.categories[2] then -- Combat / Бой
    ...
    elseif currentCategory == txt.categories[3] then -- ESP
    ...
    elseif currentCategory == txt.categories[4] then -- Settings / Настройки
        -- Настройка цвета ESP
...
print("✅ PRISON RP ULTRA V42 by shasik_1488 загружен!")
