...
-- PRISON RP | ВСЁ РАБОТАЕТ | СНЕГ ВЕЗДЕ
-- ============================================
...
-- ТЕЛЕФОН: зажимаешь левую половину экрана
...
-- ============================================
-- WALLBANG (ДЛЯ ТЕЛЕФОНА - ПО КАСАНИЮ)
-- ============================================
...
-- TRIGGERBOT (ДЛЯ ТЕЛЕФОНА - ПО КАСАНИЮ)
