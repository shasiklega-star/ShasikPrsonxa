...
-- Сохранение дефолтных настроек Lighting для отмены эффектов
...
local function updateWeather()
    ...
    elseif _G.WeatherSunsetEnabled then
        ...
        Lighting.OutdoorAmbient = Color3.fromRGB(255, 130, 80)
    elseif _G.WeatherStormEnabled then
        Lighting.TimeOfDay = "14:00:00"
        Lighting.Brightness = 0.1
        Lighting.FogEnd = 300
        Lighting.FogColor = Color3.fromRGB(30, 35, 40)
...
for i, name in pairs(tabs) do
    ...
    tabObjects[name] = {Container = tabContainer, Stroke = stroke, Button = tabBtn, Dot = dot}

    tabBtn.MouseButton1Click:Connect(function()
        playClickAnimation(tabBtn)
        if currentActive == name then return end
        currentActive = name

        for tName, obj in pairs(tabObjects) do
            if tName == name then
                obj.Container.BackgroundColor3 = Color3.fromRGB(22, 28, 38)
                obj.Stroke.Color = Color3.fromRGB(53, 132, 228)
                obj.Button.TextColor3 = Color3.fromRGB(255, 255, 255)
                obj.Dot.Visible = true
            else
                obj.Container.BackgroundColor3 = Color3.fromRGB(16, 16, 22)
                obj.Stroke.Color = Color3.fromRGB(45, 45, 55)
                obj.Button.TextColor3 = Color3.fromRGB(180, 180, 190)
...
if tabObjects["Персонаж"] then
    currentActive = "Персонаж"
    tabObjects["Персонаж"].Container.BackgroundColor3 = Color3.fromRGB(22, 28, 38)
    tabObjects["Персонаж"].Stroke.Color = Color3.fromRGB(53, 132, 228)
    tabObjects["Персонаж"].Button.TextColor3 = Color3.fromRGB(255, 255, 255)
    tabObjects["Персонаж"].Dot.Visible = true
    loadPersonageTab()
end
