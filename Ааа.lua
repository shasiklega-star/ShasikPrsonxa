-- ============================================
-- ULTRA MEGA CHEAT V24.0 (РАБОЧИЙ)
-- by shasik_1488 | ПРОВЕРЕНО
-- ============================================
...
speedToggle.Size = UDim2.new(1, 0, 0, 36)
...
print("✅ ULTRA MEGA CHEAT V24.0 by shasik_1488 загружен!")
