...
-- ============================================
-- ИКОНКА (МАКСИМАЛЬНО РЕАЛИСТИЧНАЯ, ПЛАВНАЯ)
-- ============================================
...
iconBtn.MouseButton1Click:Connect(function()
    ...
    if menuVisible then
        ...
        local targetPos = UDim2.new(0.5, -210, 0.15, 0)
        for i = 1, 25 do
            local t = i / 25
            local ease = t * t * (3 - 2 * t)
            frame.Size = UDim2.new(0, 420 * ease, 0, 480 * ease)
            frame.Position = UDim2.new(0.5, -210 * ease, 0.15 + 0.05 * (1 - ease), 0)
        ...
        for i = 1, 25 do
            ...
            frame.Position = UDim2.new(0.5, -210 * (1 - ease), 0.15 + 0.05 * ease, 0)
