...
function updateContent()
    ...
    elseif currentCategory == 2 then
        ...
        -- ВЫБОР ЦЕЛИ (появляется только когда включён Aimbot)
        if states.aimbot then
    ...
    elseif currentCategory == 3 then
        ...
        -- ЦВЕТ ESP (появляется только когда включён ESP)
        if states.esp then
        ...
        -- ЦВЕТ ХП (появляется только когда включён ХП)
