-- ============================================
-- PRISON RP ULTRA V30.0 (СНЕГ В МЕНЮ)
-- by shasik_1488 | КРАСИВЫЙ СНЕГ
-- ============================================
...
local function createSnow()
    for i = 1, 100 do
        ...
        particle.ClipsDescendants = true
        
        local speed = 0.3 + math.random() * 0.5
        local wobble = math.random() * 100
        
        spawn(function()
            while true do
                local pos = particle.Position
                local xOffset = math.sin(wobble + tick() * 0.5) * 0.002
                particle.Position = UDim2.new(pos.X.Scale + xOffset, 0, pos.Y.Scale + speed * 0.003, 0)
...
function updateContent()
    ...
    if currentCategory == "Main" then
        ...
        for _, btn in ipairs(mainBtns) do
            ...
            b.Text = states[btn.state] and btn.name .. "    [⊂❍]" or btn.name .. "    [❍⊃]"
            b.TextColor3 = states[btn.state] and Color3.fromRGB(0, 255, 100) or Color3.fromRGB(255, 255, 255)
            b.BackgroundColor3 = Color3.fromRGB(20, 20, 50)
            b.BackgroundTransparency = 0.2
            b.Font = Enum.Font.SourceSansBold
            b.TextSize = 15
            b.BorderSizePixel = 1
            b.BorderColor3 = states[btn.state] and Color3.fromRGB(0, 255, 100) or Color3.fromRGB(0, 150, 255)
            b.ZIndex = 10
...
print("✅ PRISON RP ULTRA V30.0 by shasik_1488 загружен!")
