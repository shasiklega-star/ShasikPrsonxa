-- ============================================
-- PRISON RP ULTRA V59 (УЛЬТРА-ДИЗАЙН)
-- by shasik_1488 | ВСЁ РАБОТАЕТ + КРАСИВО
-- ============================================
...
titleShadow.Size = UDim2.new(1, 0, 0, 55)
titleShadow.Text = "✦ shasik_1488 ✦"
...
local jumpBtn, noclipBtn, flyBtn, espBtn, aimBtn, invBtn, tpBtn
...
function updateContent()
    ...
    if currentCategory == 1 then -- Главная
        ...
        -- Остальные кнопки (с закруглениями)
...
print("✅ PRISON RP ULTRA V59 by shasik_1488 загружен!")
